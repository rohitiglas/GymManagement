...
import {  ActivityIndicator,Image,TouchableOpacity,
        ...
        return (
            <View style={styles.container}>
                <View style={{alignItems:'center',
                    backgroundColor:'#428d0c',height:60,width:'100%',flexDirection:'row',justifyContent:'space-between'}}>
                    <Text style={{marginLeft:20,color:'#FFFFFF',fontSize:16,fontWeight:'bold'}}>Food Category</Text>



                    <TouchableOpacity style={{marginRight:20,width: 40, height: 40}} onPress={this.cartPress}>
                        <Image
                    ...
                    <View style={{backgroundColor:'#FFFFFF',height:25,width:25,borderRadius:12.5,borderColor:'#FFFFFF',
                        ...
                        <Text style={{textAlign:'center'}} >{this.props.cartQuantity}</Text>
                    </View>
                    }
