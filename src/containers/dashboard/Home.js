...
class Home extends PureComponent {
  ...
  async componentDidMount() {
    ...
    this.props.actions.userProfile.userProfile(
  ...
  onPunchClick = async () => {
    ...
    this.props.actions.userPunch.userPunch(
      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <Text style={{fontSize: 20, color: '#FFF', fontWeight: 'bold'}}>
            {this.props.selectedRow ? this.props.selectedRow : 'Home'}
          </Text>
        </View>

        {this.props.selectedRow === 'Home' && (
          <Attendance
            onPunchClick={this.onPunchClick}
            userPunch={this.props.userPunch}
          />
        )}
        ...
        {this.props.selectedRow === 'ChangePassword' && <ChangePassword />}
