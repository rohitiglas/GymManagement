...
const Attendance=(props)=>{
    let isPunch=props.userPunch && Object.entries(props.userPunch).length === 0
    ...
    return(
        <View style={{margin:20}}>
            <Card style={{width:'100%'}}>
                ...
                <Card onPress={props.onPunchClick}
                    ...
                    <View>
                        <Text style={{marginTop:15,color:'#FFFFFF',fontSize:16,}}>
                            IN TIME :  {props.userPunch?getTimeFromDate(props.userPunch.checkInTime):''}
                        </Text>
                        <Text style={{marginBottom:30,marginTop:5,color:'#FFFFFF',fontSize:16,}}>
                            OUT TIME :  {props.userPunch?(props.userPunch.checkOutTime>0?getTimeFromDate(props.userPunch.checkOutTime):''):''}
                        </Text>
                    </View>
                    }
